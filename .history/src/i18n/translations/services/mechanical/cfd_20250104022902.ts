      ...
      cfd2: {
        ...
        modeling: {
          ...
          geometry: {
            ...
            content2: 'Ces domaines ont été modélisés pour tenir compte de l\'interaction entre le fluide et le solide, permettant une évaluation précise des transferts thermiques',
            domains: [
        ...
        results: {
          ...
          temperature: {
            ...
            titleCaption: 'Champ de température – vue de coupe du moule',
          ...
          streamlines: {
            ...
            titleCaption: 'Lignes de courant et champ de température - Moule',
      ...
      cfd1: {
        ...
        modeling: {
          ...
          geometry: {
            ...
            content2: 'For this analysis, only the fluid domain was considered. The flow passage channel design was created in an aluminum block using a drilling tool.',
            captions: {
      ...
      cfd2: {
        ...
        modeling: {
          ...
          geometry: {
            ...
            content2: 'These domains were modeled to account for the interaction between fluid and solid, enabling precise evaluation of heat transfers',
            domains: [
        ...
        results: {
          ...
          temperature: {
            ...
            titleCaption: 'Temperature field - mold cross-sectional view',
          ...
          streamlines: {
            ...
            titleCaption: 'Streamlines and temperature field - Mold',
