...
type ServiceTitle = 'Analyse de conformité' | 'Compliance Analysis' | 'Mesures équivalentes' | 'Alternative Solutions';
...
const serviceIcons: Record<ServiceTitle, LucideIcon> = {
  ...
  'Mesures équivalentes': SERVICE_ICONS.codes.services.alternative,
