...
type ServiceTitle = 'Analyse de conformité' | 'Compliance Analysis' | 'Mesures différentes' | 'Equivalent solutions';
...
const serviceIcons: Record<ServiceTitle, LucideIcon> = {
  ...
  'Equivalent solutions': SERVICE_ICONS.codes.services.alternative,
};
